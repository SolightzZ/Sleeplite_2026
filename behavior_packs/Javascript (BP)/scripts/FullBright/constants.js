export const FULL_BRIGHT_TAG = "fullbright_enabled";
export const TRIGGER_ITEM_ID = "addon:fullbright_toggle";
export const NIGHT_VISION_EFFECT_ID = "night_vision";

export const EFFECT_DURATION_TICKS = 20 * 60 * 20;
export const EFFECT_AMPLIFIER_LEVEL = 0;
